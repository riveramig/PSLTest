...
public class ImpresorLCD {
    ...
    static final String REGEX="([1-9]|1[0])[,]\\d+";
     ...
     */  
    public boolean procesar(String comando, int espacioDig) {
        ...
        if(comando.matches(REGEX)){
            ...
            throw new IllegalArgumentException("Cadena ingresada incorrecta");
        }
    }
